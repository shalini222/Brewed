      ...
      <div className="profile-page">
        <div className="profile-card">
          ...
          <div className="profile-header">
            ...
            {isEditing && <><input type="file" onChange={handleImageUpload} /><div onClick={handleRemovePhoto} style={{cursor:'pointer', color:'#C4956A', marginTop:'5px'}}>Remove</div></>}
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="form-grid">
              ...
              <div className="form-group full">
                ...
                <input placeholder="Street address..." value={address} onChange={(e) => setAddress(e.target.value)} disabled={!isEditing} />
              </div>
